DeepSpeed Version 13.2 with CUDA 12.1 - Installation Instructions:

1. Download the 13.2 release of [DeepSpeed 13.2](https://github.com/microsoft/DeepSpeed/releases/tag/v0.13.2) extract it to a folder. 
...
10. Modify the following files:<br>
 ...
 deepspeed-0.13.2/build_win.bat - at the top of the file, add:<br>
 ```
...
```
deepspeed-0.13.2/csrc/quantization/pt_binding.cpp - lines 244-250 - change to:
```
...
deepspeed-0.13.2/csrc/transformer/inference/csrc/pt_binding.cpp
...
deepspeed-0.13.1/deepspeed/env_report.py
line 10 - add:
```
import psutil
```
