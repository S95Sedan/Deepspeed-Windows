...
1. Download the 14.0 release of [DeepSpeed 14.0](https://github.com/microsoft/DeepSpeed/releases/tag/v0.14.0) extract it to a folder. 
...
deepspeed-0.14.0/csrc/transformer/inference/csrc/pt_binding.cpp
...
deepspeed-0.14.0/deepspeed/env_report.py
line 10 - add:
```
import psutil
```
