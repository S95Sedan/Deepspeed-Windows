...
1. Download the 13.1 release of [DeepSpeed 13.1](https://github.com/microsoft/DeepSpeed/releases/tag/v0.13.1) extract it to a folder. 
...
10. Modify the following files:<br>
 ...
 deepspeed-0.13.1/build_win.bat - at the top of the file, add:<br>
 ```
...
deepspeed-0.13.1/csrc/transformer/inference/csrc/pt_binding.cpp
