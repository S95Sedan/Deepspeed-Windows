DeepSpeed Version 12.6 with CUDA 12.1 - Installation Instructions:

1. Download the 12.6 (or 12.7 main) release of [DeepSpeed 12.6](https://github.com/microsoft/DeepSpeed/releases/tag/v0.12.6) extract it to a folder. 
...
10. Modify the following files:<br>
 ...
 deepspeed-0.12.6/build_win.bat - at the top of the file, add:<br>
 ```
...
```
deepspeed-0.12.6/csrc/quantization/pt_binding.cpp - lines 244-250 - change to:
```
...
deepspeed-0.12.6/csrc/transformer/inference/csrc/pt_binding.cpp
...
deepspeed-0.12.6/deepspeed/env_report.py
line 10 - add:
```
import psutil
```
